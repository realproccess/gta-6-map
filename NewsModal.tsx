...
import { X, ArrowLeft, Clock, CheckCircle2, AlertTriangle, Eye, CalendarDays } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex justify-center items-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      <div className="ui-panel relative w-full max-w-6xl flex flex-col text-white">
        ...
        {/* RIGHT COLUMN: The Interactive Timeline */}
        <div className="lg:col-span-7">
          <div className="bg-[#121218] rounded-3xl p-8 border border-white/5 shadow-2xl relative">
            
            {/* Vertical Line */}
            <div className="absolute left-[51px] top-12 bottom-12 w-0.5 bg-gradient-to-b from-pink-500 via-purple-500 to-gray-700"></div>
            
            <h2 className="text-3xl font-black italic text-white mb-10 tracking-widest pl-4">THE TIMELINE</h2>
              ...
              {timelineData.map((item, index) => (
                <div key={index} className="flex gap-6 relative">
                  ...
                  <div className="flex-1 bg-white/5 hover:bg-white/10 transition-colors rounded-2xl p-6 border border-white/5">
                    ...
                    {/* Embedded YouTube Trailer if it's a video event */}
                    {item.videoId && (
